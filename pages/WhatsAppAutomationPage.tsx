                ...
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                    <div className="text-left">
                        ...
                        <AnimatedElement delay={200} className="mt-8">
                            <button className="px-8 py-3 rounded-lg font-semibold bg-whatsapp-green text-white shadow-lg shadow-green-500/30 hover:opacity-90 transition-all transform hover:scale-105 inline-flex items-center gap-2">
                                <WhatsAppIcon className="w-5 h-5" /> Book a Free WhatsApp Automation Audit
                            </button>
                        </AnimatedElement>
                    </div>
                ...
                <div className="text-center max-w-3xl mx-auto">
                    <AnimatedElement>
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                            <button className="px-8 py-3 rounded-lg font-semibold bg-white text-black shadow-lg hover:opacity-90 transition-all transform hover:scale-105">Book a Demo Call</button>
