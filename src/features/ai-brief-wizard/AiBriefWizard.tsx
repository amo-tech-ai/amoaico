...
import { XIcon, CheckCircleIcon, QuestionMarkCircleIcon } from '../../assets/icons';
            ...
            case 'welcome': return (
                <div className={animationClass} key="welcome">
                    ...
                    <div className="mt-8 text-right">
                        <button onClick={() => goToStep('scope')} disabled={!isWelcomeStepComplete} className="px-8 py-3 rounded-lg font-semibold bg-[#F97316] text-white transition-all disabled:bg-gray-300 active:scale-95">Next: Define Scope →</button>
                    </div>
                </div>
            );
            case 'scope': return (
                <div className={animationClass} key="scope">
                    ...
                    <div className="mt-8 flex justify-between items-center">
                         <button onClick={() => goToStep('welcome', 'left')} className="px-6 py-2 rounded-lg font-semibold text-[#0F172A] border border-gray-300 hover:bg-gray-100 active:scale-95">Back</button>
                        <button onClick={generateAndSaveBrief} disabled={!isScopeStepComplete} className="px-8 py-3 rounded-lg font-semibold bg-[#F97316] text-white transition-all disabled:bg-gray-300 active:scale-95">Next: AI Enrichment →</button>
                    </div>
                </div>
            );
                ...
                <div className="flex flex-col items-center justify-center h-full text-center py-12">
                     ...
                     {generationStatus === 'error' && (
                         <>
                             ...
                             <button onClick={generateAndSaveBrief} className="mt-6 px-6 py-2 rounded-lg font-semibold bg-[#F97316] text-white active:scale-95">Retry</button>
                         </>
                     )}
                </div>
            );
                ...
                <div className={animationClass} key="review">
                    ...
                    <div className="space-y-6 max-h-[350px] overflow-y-auto pr-4">
                     ...
                     <div className="mt-8 flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                        <button onClick={() => goToStep('scope', 'left')} className="w-full sm:w-auto px-6 py-2 rounded-lg font-semibold text-[#0F172A] border border-gray-300 hover:bg-gray-100 active:scale-95">Back to Edit</button>
